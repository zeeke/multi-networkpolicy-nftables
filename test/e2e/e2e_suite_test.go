...
var (
	...
	projectImage = "github.com/k8snetworkplumbingwg/multi-networkpolicy-nftables:v0.0.1"
)
...
func TestE2E(t *testing.T) {
	...
	_, _ = fmt.Fprintf(GinkgoWriter, "Starting multi-networkpolicy-nftables integration test suite\n")
